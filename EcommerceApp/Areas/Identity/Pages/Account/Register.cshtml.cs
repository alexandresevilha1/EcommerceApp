...
namespace EcommerceApp.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        //private readonly IEmailSender _emailSender; // Mantém este
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //await _emailSender.SendEmailAsync(Input.Email, "Confirme seu email", // Traduzido
                    //    $"Por favor, confirme sua conta <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicando aqui</a>."); // Traduzido
